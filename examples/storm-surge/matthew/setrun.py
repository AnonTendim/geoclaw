...
# Landfall for Matthew near Trident is 10/7/2016 6 a.m.
landfall = datetime.datetime(2016, 10, 7, 6) - \
...
def setrun(claw_pkg='geoclaw'):
    ...
    # Gauge from 
    # rundata.gaugedata.gauges.append([1, -80.16167, 25.73167,
    #                                 rundata.clawdata.t0,
    #                                 rundata.clawdata.tfinal])
    # rundata.gaugedata.gauges.append([2, -80.035, 26.61333,
    #                                 rundata.clawdata.t0,
    #                                 rundata.clawdata.tfinal])
    rundata.gaugedata.gauges.append([3, -80.59333, 28.415, rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
    rundata.gaugedata.gauges.append([4, -81.42833, 30.39833,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
    rundata.gaugedata.gauges.append([5, -81.55833, 30.38667, rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
    rundata.gaugedata.gauges.append([6, -81.465, 30.67167, rundata.clawdata.t0,
                                     rundata.clawdata.tfinal]) 
...
def setgeo(rundata):
    ...
    # the smaller domains
    topo_path = os.path.join(scratch_dir, 'gulf.asc')
